...
@Component({
  ...
  styles: [`
    ...
    .sig-color-picker__trigger:hover:not(:disabled) {
      border-color: #9ca3af;
    }

    .sig-color-picker__trigger:disabled {
      opacity: 0.5;
      cursor: not-allowed;
    }

    .sig-color-picker__preview {
      width: 1.5rem;
      height: 1.5rem;
    ...
    .sig-color-picker__value {
      font-size: 0.75rem;
      font-family: monospace;
      color: #374151;
    }

    .sig-color-picker__dropdown {
      position: absolute;
      top: 100%;
      left: 0;
      z-index: 50;
    ...
    .sig-color-picker__saturation-white {
      position: absolute;
      inset: 0;
    ...
    .sig-color-picker__saturation-black {
      position: absolute;
      inset: 0;
    ...
    .sig-color-picker__saturation-cursor {
      position: absolute;
      width: 12px;
      height: 12px;
    ...
    .sig-color-picker__alpha::before {
      content: '';
      position: absolute;
      inset: 0;
      border-radius: inherit;
      background: linear-gradient(to right, transparent, var(--alpha-color, black));
    }

    .sig-color-picker__alpha-cursor {
      position: absolute;
      top: 50%;
      width: 14px;
      height: 14px;
    ...
    .sig-color-picker__preset--selected {
      box-shadow: 0 0 0 2px #3b82f6;
    }

    /* Input */
    .sig-color-picker__input-container {
      display: flex;
      gap: 0.25rem;
      margin-bottom: 0.75rem;
    }

    .sig-color-picker__input {
      flex: 1;
    ...
    /* Footer */
    .sig-color-picker__footer {
      display: flex;
      justify-content: flex-end;
      gap: 0.5rem;
    }

    .sig-color-picker__footer button {

...
@Component({
  ...
  styles: [`
    ...
    .sig-date-range__trigger:focus {
      outline: none;
      border-color: #3b82f6;
      box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1);
    }

    .sig-date-range__value {
      flex: 1;
      text-align: left;
    }

    .sig-date-range__placeholder {
      color: #9ca3af;
    }

    .sig-date-range__clear {
      padding: 0.125rem;
      border: none;
      background: none;
      color: #9ca3af;
    ...
    .sig-date-range__clear:hover {
      color: #374151;
    }

    .sig-date-range__dropdown {
      position: absolute;
      top: 100%;
      left: 0;
      z-index: 50;
    ...
    .sig-date-range__preset:hover {
      background-color: #f3f4f6;
    }

    .sig-date-range__calendars {
      display: flex;
      gap: 1rem;
      padding: 1rem;
    }

    .sig-date-range__calendar {
      min-width: 250px;
    }

    .sig-date-range__calendar-header {
      display: flex;
      align-items: center;
    ...
    .sig-date-range__calendar-header button {
      padding: 0.25rem 0.5rem;
      border: none;
      background: none;
      cursor: pointer;
    ...
    .sig-date-range__calendar-header button:hover {
      background-color: #f3f4f6;
    }

    .sig-date-range__weekdays {
      display: grid;
    ...
    .sig-date-range__day:hover:not(:disabled) {
      background-color: #f3f4f6;
    }

    .sig-date-range__day--other {
      color: #d1d5db;
    }

    .sig-date-range__day--today {
      font-weight: 700;
      color: #3b82f6;
    }

    .sig-date-range__day--selected,
    .sig-date-range__day--range-start,
    .sig-date-range__day--range-end {
    ...
    .sig-date-range__day--in-range {
      background-color: #dbeafe;
      border-radius: 0;
    }

    .sig-date-range__day--disabled {
      color: #d1d5db;
      cursor: not-allowed;
    }

    .sig-date-range__footer {
      display: flex;
      align-items: center;
      justify-content: space-between;
      padding: 0.75rem;
    ...
    .sig-date-range__selection {
      font-size: 0.75rem;
      color: #6b7280;
    }

    .sig-date-range__actions {
      display: flex;
      gap: 0.5rem;
    }

    .sig-date-range__actions button {
    ...
    .sig-date-range__apply {
      background-color: #3b82f6 !important;
      border-color: #3b82f6 !important;
      color: white;
    }

    .sig-date-range__apply:disabled {
      opacity: 0.5;
      cursor: not-allowed;
    }
  `],
